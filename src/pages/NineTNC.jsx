...
const STUDENTS = [
  ...
  { name: "Student 4",          scores: [1,1,1,1,1,1,1], total: 5  },
  { name: "Student 5",        scores: [3,2,2,2,1,2,3], total: 20 },
  { name: "Student 6",        scores: [2,2,1,2,1,1,2], total: 12 },
  { name: "Student 7",           scores: [1,1,1,1,1,1,1], total: 6  },
  { name: "Student 8",             scores: [2,2,1,2,2,3,2], total: 16 },
  { name: "Student 9",          scores: [2,2,1,3,1,1,2], total: 10 },
  { name: "Student 10",                scores: [2,3,2,2,3,1,2], total: 19 },
  { name: "Student 11",            scores: [2,2,3,2,2,1,3], total: 16 },
  { name: "Student 12",        scores: [1,1,2,2,1,1,1], total: 8  },
  { name: "Student 13",           scores: [2,2,1,3,2,2,3], total: 15 },
  { name: "Student 14",          scores: [2,1,1,1,1,1,1], total: 9  },
  { name: "Student 15",           scores: [3,2,1,1,3,3,2], total: 18 },
  { name: "Student 16",         scores: [3,2,2,3,3,3,3], total: 25 },
  { name: "Student 17",             scores: [2,2,1,1,1,2,2], total: 12 },
  { name: "Student 18",               scores: [2,3,2,3,3,3,3], total: 20 },
  { name: "Student 19",       scores: [2,2,2,2,1,1,2], total: 11 },
  { name: "Student 20",          scores: [2,1,2,2,1,1,1], total: 9  },
  { name: "Student 21",          scores: [2,2,2,1,1,1,1], total: 8  },
  { name: "Student 22",          scores: [1,1,1,3,1,1,1], total: 6  },
  { name: "Student 23",          scores: [1,2,1,1,1,1,1], total: 7  },
  { name: "Student 24",         scores: [2,3,2,3,2,3,2], total: 21 },
  { name: "Student 25",           scores: [2,2,1,2,1,1,1], total: 10 },
  { name: "Student 26",         scores: [3,2,3,3,2,3,2], total: 21 },
  { name: "Student 27",         scores: [3,3,2,2,2,3,3], total: 24 },
  { name: "Student 28",           scores: [3,3,3,2,3,3,3], total: 25 },
  { name: "Student 29",              scores: [2,3,2,3,3,3,3], total: 23 },
  { name: "Student 30",            scores: [1,2,3,3,3,3,3], total: 20 },
]
